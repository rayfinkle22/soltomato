  ...
  return (
    <section id="chart" className="relative z-10 py-6 sm:py-8 px-4">
      <div className="max-w-3xl mx-auto">
        <h2 className="font-display text-3xl sm:text-4xl text-center text-primary mb-1">
          Live Chart 📈
        </h2>
        <p className="font-body text-center text-foreground/70 mb-4">
        ...
        <div className="mb-6 p-4 rounded-2xl border border-white/20 bg-white/80 backdrop-blur-sm">
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              <p className="font-body text-sm text-background/70 mb-1">Market Cap</p>
              <p className="font-display text-xl sm:text-2xl text-background">
                {isLoading ? (
            ...
            <div className="text-center">
              <p className="font-body text-sm text-background/70 mb-1">24h Txns</p>
              <p className="font-display text-xl sm:text-2xl text-background">
                {isLoading ? (
                  <span className="animate-pulse">...</span>
                ) : totalTxns !== null ? (
            ...
            <div className="text-center">
              <p className="font-body text-sm text-background/70 mb-1">24h Change</p>
              <p className="font-display text-xl sm:text-2xl text-background">
                {isLoading ? (
                  <span className="animate-pulse">...</span>
                ) : priceChange24h !== null ? (
        ...
        <div className="rounded-2xl border border-primary/30 overflow-hidden bg-primary/10 backdrop-blur-sm">
          <iframe
        ...
        <p className="text-center mt-4">
          <a
            ...
            className="font-body text-primary hover:text-secondary transition-colors inline-flex items-center gap-2 underline underline-offset-2"
          >
